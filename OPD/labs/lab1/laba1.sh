...
cd ..
echo test
ls -lRt lab0 | grep "clown"| tail -n 2

echo ""

cat lab0/dragonite5/* | sort -r

echo""

cat lab0/ludicolo0 | grep -vn "y$"

echo ""

cat lab0/pikachu2/* | sort -r | cat -n

echo""

ls -lRt lab0 | head -n 6 | tail -n 4

echo ""

cat lab0/seedot5/{pidove,ralts,pidgey,spheal} | grep -n "fen"

echo ""

ls -lS lab0/v* lab0/*/v* lab0/*/*/v* | grep "clown" | head -n 2

echo ""

cat lab0/dragonite5/dusclops/{masquerain,bellsprout,bidoof} lab0/dragonite5/vigoroth lab0/dragonite5/grovyle{blissey,machamp,conkeldurr,lotad} lab0/pikachu2/misdreavus lab0/likachu2/chimchar/kabuto | grep -v "ron" 2>&1

echo ""

cat lab0/*5 lab0/*/*5 lab0/*/*/*5 | sort -r 

echo ""
mkdir tmp
touch output
cat lab0/venonat5 | wc -m >> lab0/venonat5 2>>tmp/output

echo ""

cat lab0/seedot5/* 2>>tmp/output | grep -v "y$"
...
#5
echo section 5
rm -f lab0/seaking3 2>/dev/null
rm -f lab0/dragonite5/dusclops/bidoof
rm -f lab0/dragonite5/watchogvenon*
rm -f lab0/dragonite5/scraftyvenon*
rm -Rf lab0/dragonite5
