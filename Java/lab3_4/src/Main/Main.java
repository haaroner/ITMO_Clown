...
public class Main {
   public static void main(String[] args) throws Exception {
      ...
      Alliens gopniki = new Alliens("gopniki", 8, "их было двое");
      Actor vasya = new Actor("Vasya", 2, "Главный герой");//------name-null--- ili udalit obj
